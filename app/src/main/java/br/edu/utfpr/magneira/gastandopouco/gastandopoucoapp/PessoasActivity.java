...
public class PessoasActivity extends AppCompatActivity {
    ...
    private void carregaPessoas(){
        ...
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                GastosDatabase database = GastosDatabase.getDatabase(PessoasActivity.this);
                                ...
                                AsyncTask.execute(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        GastosDatabase database =
                                                GastosDatabase.getDatabase(PessoasActivity.this);
            ...
            public void run() {
                ...
                if (total == 0){
                    ...
                    PessoasActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UtilGUI.avisoErro(PessoasActivity.this, R.string.nenhum_tipo);
                        }
                    });
                ...
                if (total == 0){
                    ...
                    PessoasActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UtilGUI.avisoErro(PessoasActivity.this, R.string.nenhum_tipo_contato);
                        }
                    });
